...
//+kubebuilder:rbac:groups=dataplane.openstack.org,resources=openstacknets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dataplane.openstack.org,resources=openstacknets/status,verbs=get;update;patch
...
func (r *OpenStackNetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	instance := &dataplanev1beta1.OpenStackNet{}
	...
	defer func() {
		if err == nil {
			instance.Status.Conditions.MarkTrue(dataplanev1beta1.OpenStackNetworkReadyCondition, dataplanev1beta1.OpenStackNetworkReadyMessage)
		}
	...
	if instance.Status.Reservations == nil {
		instance.Status.Reservations = []dataplanev1beta1.IPReservation{}
	}
...
func (r *OpenStackNetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dataplanev1beta1.OpenStackNet{}).
