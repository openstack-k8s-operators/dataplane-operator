...
func (in *OpenStackDataPlaneDeploymentSpec) DeepCopyInto(out *OpenStackDataPlaneDeploymentSpec) {
	*out = *in
	...
	if in.AllNodeSetsServices != nil {
		in, out := &in.AllNodeSetsServices, &out.AllNodeSetsServices
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *OpenStackDataPlaneServiceSpec) DeepCopyInto(out *OpenStackDataPlaneServiceSpec) {
	*out = *in
	...
	if in.DeployOnAllNodeSets != nil {
		in, out := &in.DeployOnAllNodeSets, &out.DeployOnAllNodeSets
		*out = new(bool)
		**out = **in
	}
}
