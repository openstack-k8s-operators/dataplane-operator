...
type OpenStackDataPlaneNodeSetSpec struct {
	...
	// +kubebuilder:validation:Optional
	// +kubebuilder:default={download-cache,bootstrap,configure-network,validate-network,install-os,configure-os,ssh-known-hosts,run-os,install-certs,ovn,neutron-metadata,libvirt,nova,telemetry}
	// Services list
