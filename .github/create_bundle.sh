...
CLUSTER_BUNDLE_FILE="bundle/manifests/dataplane-operator.clusterserviceversion.yaml"

echo "Creating dataplane operator bundle"
cd ..
echo "${GITHUB_SHA}"
echo "${BASE_IMAGE}"
skopeo --version
...
# Output:
# Calculating image digest for docker://quay.io/openstack-k8s-operators/dataplane-operator:d03f2c1c362c04fc5ef819f92a218f9ea59bbd0c
