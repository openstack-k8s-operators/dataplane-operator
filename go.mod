...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.0.0-20230307144813-39ed0da90b23
...
require (
	...
	github.com/openstack-k8s-operators/infra-operator/apis v0.0.0-20230221114633-d3cedda6974d // indirect
	github.com/openstack-k8s-operators/keystone-operator/api v0.0.0-20230228092947-37346b60ff49 // indirect
	github.com/openstack-k8s-operators/lib-common/modules/database v0.0.0-20230227110324-8f0c518c552b // indirect
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.0.0-20230215134634-d31141e5bbba // indirect
	github.com/openstack-k8s-operators/mariadb-operator/api v0.0.0-20230227100533-e49b65b3e3df // indirect
	github.com/openstack-k8s-operators/nova-operator v0.0.0-20230303151818-673d8c1c9b80 // indirect
