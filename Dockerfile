...
ARG IMAGE_COMPONENT="dataplane-operator-container"
ARG IMAGE_NAME="dataplane-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="OpenStack Data plane Operator"
ARG IMAGE_DESC="This image includes the dataplane-operator"
