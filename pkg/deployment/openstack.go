...
func InstallOpenStack(ctx context.Context, helper *helper.Helper, obj client.Object, sshKeySecret string, inventoryConfigMap string) error {
	...
	err := dataplaneutil.AnsibleExecution(ctx, helper, obj, InstallOpenStackLabel, sshKeySecret, inventoryConfigMap, "", role)
	if err != nil {
