...
func GenerateNodeSetInventory(ctx context.Context, helper *helper.Helper,
	...
	containerImages dataplanev1.ContainerImages) (string, error) {
...
func resolveGroupAnsibleVars(template *dataplanev1.NodeTemplate, group *ansible.Group,
	containerImages dataplanev1.ContainerImages) error {
	...
	if template.Ansible.AnsibleVars["edpm_frr_image"] == nil {
		group.Vars["edpm_frr_image"] = containerImages.FrrImage
	}
	if template.Ansible.AnsibleVars["edpm_iscsid_image"] == nil {
		group.Vars["edpm_iscsid_image"] = containerImages.IscsiDImage
	}
	if template.Ansible.AnsibleVars["edpm_logrotate_crond_image"] == nil {
		group.Vars["edpm_logrotate_crond_image"] = containerImages.LogrotateCrondImage
	}
	if template.Ansible.AnsibleVars["edpm_neutron_metadata_agent_image"] == nil {
		group.Vars["edpm_neutron_metadata_agent_image"] = containerImages.NeutronMetadataAgentImage
	}
	if template.Ansible.AnsibleVars["edpm_neutron_sriov_agent_image"] == nil {
		group.Vars["edpm_neutron_sriov_image"] = containerImages.NeutronSRIOVAgentImage
	}
	...
	if template.Ansible.AnsibleVars["edpm_ovn_bgp_agent_image"] == nil {
		group.Vars["edpm_ovn_bgp_agent_image"] = containerImages.OvnBgpAgentImage
	}
	if template.Ansible.AnsibleVars["edpm_telemetry_ceilometer_compute_image"] == nil {
		group.Vars["edpm_telemetry_ceilometer_compute_image"] = containerImages.TelemetryCeilometerComputeImage
	}
	if template.Ansible.AnsibleVars["edpm_telemetry_ceilometer_ipmi_image"] == nil {
		group.Vars["edpm_telemetry_ceilometer_ipmi_image"] = containerImages.TelemetryCeilometerIpmiImage
	}
	if template.Ansible.AnsibleVars["edpm_telemetry_node_exporter_image"] == nil {
		group.Vars["edpm_telemetry_node_exporter_image"] = containerImages.TelemetryNodeExporterImage
	}
