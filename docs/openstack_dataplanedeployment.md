...
| extraVars | ExtraVars for ansible execution | map[string]json.RawMessage | false |
...
| ansibleLimit | AnsibleLimit for ansible execution | string | false |
| ansibleSkipTags | AnsibleSkipTags for ansible execution | string | false |
| ansibleExtraVars | AnsibleExtraVars for ansible execution | map[string]json.RawMessage | false |
